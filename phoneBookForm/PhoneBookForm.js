...
function PhoneBookForm({ addUserItem }) {
  ...
  const submitHandler = (e) => {
    ...
    addUserItem(userData) // call the addUserItem function (in App.js) that was passed as a props
    setUserData(initialFormState) // reset the input form
  }
